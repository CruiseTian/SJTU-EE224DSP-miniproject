...
switch(Type)
    ...
    case(2)
        F1 = 1336;F2 = 697;%对应第二个按钮发声的频率值
    case(3)
        F1 = 1477;F2 = 697;%对应第一个按钮发声的频率值
    case(4)
        F1 = 1633;F2 = 697;%对应第二个按钮发声的频率值
    case(5)
        F1 = 1209;F2 = 770;%对应第一个按钮发声的频率值
    case(6)
        F1 = 1336;F2 = 770;%对应第二个按钮发声的频率值
    case(7)
        F1 = 1477;F2 = 770;%对应第一个按钮发声的频率值
    case(8)
        F1 = 1633;F2 = 770;%对应第二个按钮发声的频率值
    case(9)
        F1 = 1209;F2 = 852;%对应第一个按钮发声的频率值
    case(10)
        F1 = 1336;F2 = 852;%对应第二个按钮发声的频率值
    case(11)
        F1 = 1477;F2 = 852;%对应第一个按钮发声的频率值
    case(12)
        F1 = 1633;F2 = 852;%对应第二个按钮发声的频率值
    case(13)
        F1 = 1209;F2 = 941;%对应第一个按钮发声的频率值
    case(14)
        F1 = 1336;F2 = 941;%对应第二个按钮发声的频率值
    case(15)
        F1 = 1477;F2 = 941;%对应第一个按钮发声的频率值
    case(16)
